...
Histogram binning also helps in reduced memory usage and other speedups that are mentioned in the [LightGBM optimization docs](https://lightgbm.readthedocs.io/en/latest/Features.html#optimization-in-speed-and-memory-usage).
